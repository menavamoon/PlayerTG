...
@Client.on_message(filters.command(["export", "خروجی", f"export@{Config.BOT_USERNAME}"]) & admin_filter & chat_filter)
...
@Client.on_message(filters.command(["import", "ورودی", f"import@{Config.BOT_USERNAME}"]) & admin_filter & chat_filter)
